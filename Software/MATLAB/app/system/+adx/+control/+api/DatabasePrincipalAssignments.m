classdef DatabasePrincipalAssignments < adx.control.BaseClient
    ...
    % Class methods
    methods
        function obj = DatabasePrincipalAssignments(options)
        ...
        function [code, result, response] = databasePrincipalAssignmentsCheckNameAvailability(obj, resourceGroupName, clusterName, databaseName, api_version, subscriptionId, DatabasePrincipalAssignmentCheckNameRequest)
            ...
            arguments
              obj adx.control.api.DatabasePrincipalAssignments
              resourceGroupName string
              clusterName string
              databaseName string
              api_version string
              subscriptionId string
              DatabasePrincipalAssignmentCheckNameRequest adx.control.models.DatabasePrincipalAssignmentCheckNameRequest
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsCheckNameAvailability:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","databasePrincipalAssignmentsCheckNameAvailability")
            end
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsCheckNameAvailability:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","databasePrincipalAssignmentsCheckNameAvailability")
            end
            ...
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/checkPrincipalAssignmentNameAvailability";
            ...
            request.Body(1).Payload = DatabasePrincipalAssignmentCheckNameRequest.getPayload(requiredProperties,optionalProperties);
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("databasePrincipalAssignmentsCheckNameAvailability", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("databasePrincipalAssignmentsCheckNameAvailability", response, request, uri, httpOptions);
        ...
        end % databasePrincipalAssignmentsCheckNameAvailability method

        function [code, result, response] = databasePrincipalAssignmentsCreateOrUpdate(obj, subscriptionId, resourceGroupName, clusterName, databaseName, principalAssignmentName, api_version, DatabasePrincipalAssignment)
            ...
            arguments
              ...
              api_version string
              DatabasePrincipalAssignment adx.control.models.DatabasePrincipalAssignment
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsCreateOrUpdate:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","databasePrincipalAssignmentsCreateOrUpdate")
            end
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsCreateOrUpdate:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","databasePrincipalAssignmentsCreateOrUpdate")
            end
            ...
            % Append the operation end-point
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/principalAssignments/{principalAssignmentName}";
            ...
            request.Body(1).Payload = DatabasePrincipalAssignment.getPayload(requiredProperties,optionalProperties);
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("databasePrincipalAssignmentsCreateOrUpdate", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("databasePrincipalAssignmentsCreateOrUpdate", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.DatabasePrincipalAssignment(response.Body.Data);
                case 201
                    result = adx.control.models.DatabasePrincipalAssignment(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
        ...
        end % databasePrincipalAssignmentsCreateOrUpdate method

        function [code, result, response] = databasePrincipalAssignmentsDelete(obj, subscriptionId, resourceGroupName, clusterName, databaseName, principalAssignmentName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsDelete:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("databasePrincipalAssignmentsDelete", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("databasePrincipalAssignmentsDelete", response, request, uri, httpOptions);
        ...
        end % databasePrincipalAssignmentsDelete method

        function [code, result, response] = databasePrincipalAssignmentsGet(obj, subscriptionId, resourceGroupName, clusterName, databaseName, principalAssignmentName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("databasePrincipalAssignmentsGet", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("databasePrincipalAssignmentsGet", response, request, uri, httpOptions);
        ...
        end % databasePrincipalAssignmentsGet method

        function [code, result, response] = databasePrincipalAssignmentsList(obj, subscriptionId, resourceGroupName, clusterName, databaseName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:databasePrincipalAssignmentsList:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","databasePrincipalAssignmentsList")
            end
            ...
            % Append the operation end-point
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/databases/{databaseName}/principalAssignments";
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("databasePrincipalAssignmentsList", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("databasePrincipalAssignmentsList", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.DatabasePrincipalAssignmentListResult(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
            end
        
        end % databasePrincipalAssignmentsList method
