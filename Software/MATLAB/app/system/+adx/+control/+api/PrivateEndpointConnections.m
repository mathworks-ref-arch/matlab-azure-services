classdef PrivateEndpointConnections < adx.control.BaseClient
    ...
    % Class methods
    methods
        function obj = PrivateEndpointConnections(options)
        ...
        function [code, result, response] = privateEndpointConnectionsCreateOrUpdate(obj, subscriptionId, resourceGroupName, clusterName, privateEndpointConnectionName, api_version, PrivateEndpointConnection)
            ...
            arguments
              obj adx.control.api.PrivateEndpointConnections
              subscriptionId string
              resourceGroupName string
              clusterName string
              privateEndpointConnectionName string
              api_version string
              PrivateEndpointConnection adx.control.models.PrivateEndpointConnection
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:privateEndpointConnectionsCreateOrUpdate:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            elseif ismember("application/x-www-form-urlencoded",specContentTypeHeaders)
                ...
                error("control:api:privateEndpointConnectionsCreateOrUpdate:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' and 'application/x-www-form-urlencoded' MediaTypes.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","privateEndpointConnectionsCreateOrUpdate")
            end
            ...
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/privateEndpointConnections/{privateEndpointConnectionName}";
            ...
            uri.Path(uri.Path == "{" + "privateEndpointConnectionName" +"}") = privateEndpointConnectionName;
            ...
            request.Body(1).Payload = PrivateEndpointConnection.getPayload(requiredProperties,optionalProperties);
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("privateEndpointConnectionsCreateOrUpdate", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("privateEndpointConnectionsCreateOrUpdate", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.PrivateEndpointConnection(response.Body.Data);
                case 201
                    result = adx.control.models.PrivateEndpointConnection(response.Body.Data);
        ...
        end % privateEndpointConnectionsCreateOrUpdate method

        function [code, result, response] = privateEndpointConnectionsDelete(obj, subscriptionId, resourceGroupName, clusterName, privateEndpointConnectionName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:privateEndpointConnectionsDelete:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","privateEndpointConnectionsDelete")
            end
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("privateEndpointConnectionsDelete", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("privateEndpointConnectionsDelete", response, request, uri, httpOptions);
        ...
        end % privateEndpointConnectionsDelete method

        function [code, result, response] = privateEndpointConnectionsGet(obj, subscriptionId, resourceGroupName, clusterName, privateEndpointConnectionName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:privateEndpointConnectionsGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("privateEndpointConnectionsGet", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("privateEndpointConnectionsGet", response, request, uri, httpOptions);
        ...
        end % privateEndpointConnectionsGet method

        function [code, result, response] = privateEndpointConnectionsList(obj, subscriptionId, resourceGroupName, clusterName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:privateEndpointConnectionsList:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
            ...
            % Append the operation end-point
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/privateEndpointConnections";
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("privateEndpointConnectionsList", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("privateEndpointConnectionsList", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.PrivateEndpointConnectionListResult(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
            end
        
        end % privateEndpointConnectionsList method
