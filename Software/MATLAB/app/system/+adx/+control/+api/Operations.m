classdef Operations < adx.control.BaseClient
    ...
    % Class methods
    methods
        function obj = Operations(options)
        ...
        function [code, result, response] = operationsList(obj, api_version)
            ...
            arguments
              obj adx.control.api.Operations
              api_version string
            end
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:operationsList:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","operationsList")
            end
            ...
            uri.EncodedPath = uri.EncodedPath + "/providers/Microsoft.Kusto/operations";
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("operationsList", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("operationsList", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.OperationListResult(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
            end
        
        end % operationsList method
