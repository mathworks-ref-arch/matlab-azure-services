classdef PrivateLinkResources < adx.control.BaseClient
    ...
    % Class methods
    methods
        function obj = PrivateLinkResources(options)
        ...
        function [code, result, response] = privateLinkResourcesGet(obj, subscriptionId, resourceGroupName, clusterName, privateLinkResourceName, api_version)
            ...
            arguments
              obj adx.control.api.PrivateLinkResources
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:privateLinkResourcesGet:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","privateLinkResourcesGet")
            end
            ...
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/privateLinkResources/{privateLinkResourceName}";
            ...
            uri.Path(uri.Path == "{" + "privateLinkResourceName" +"}") = privateLinkResourceName;
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("privateLinkResourcesGet", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("privateLinkResourcesGet", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.PrivateLinkResource(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
            end
        
        end % privateLinkResourcesGet method

        function [code, result, response] = privateLinkResourcesList(obj, subscriptionId, resourceGroupName, clusterName, api_version)
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:privateLinkResourcesList:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","privateLinkResourcesList")
            end
            ...
            % Append the operation end-point
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/privateLinkResources";
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("privateLinkResourcesList", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("privateLinkResourcesList", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.PrivateLinkResourceListResult(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
            end
        
        end % privateLinkResourcesList method
