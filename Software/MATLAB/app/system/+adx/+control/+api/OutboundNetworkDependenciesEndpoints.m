classdef OutboundNetworkDependenciesEndpoints < adx.control.BaseClient
    ...
    % Class methods
    methods
        function obj = OutboundNetworkDependenciesEndpoints(options)
        ...
        function [code, result, response] = clustersListOutboundNetworkDependenciesEndpoints(obj, subscriptionId, resourceGroupName, clusterName, api_version)
            ...
            arguments
              obj adx.control.api.OutboundNetworkDependenciesEndpoints
            ...
            if ismember("application/json",specAcceptHeaders)
                ...
                error("control:api:clustersListOutboundNetworkDependenciesEndpoints:UnsupportedMediaType","Generated OpenAPI Classes only support 'application/json' MediaType.\n" + ...
                    "Operation '%s' does not support this. It may be possible to call this operation by first editing the generated code.","clustersListOutboundNetworkDependenciesEndpoints")
            end
            ...
            uri.EncodedPath = uri.EncodedPath + "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/outboundNetworkDependenciesEndpoints";
            ...
            % Call preSend
            [request, httpOptions, uri] = obj.preSend("clustersListOutboundNetworkDependenciesEndpoints", request, httpOptions, uri);
            ...
            % Call postSend
            response = obj.postSend("clustersListOutboundNetworkDependenciesEndpoints", response, request, uri, httpOptions);

            % Handle response
            code = response.StatusCode;
            switch (code)
                case 200
                    result = adx.control.models.OutboundNetworkDependenciesEndpointListResult(response.Body.Data);
                otherwise % Default output as specified in spec
                    result = adx.control.models.ErrorResponse(response.Body.Data);
            end
        
        end % clustersListOutboundNetworkDependenciesEndpoints method
