classdef PrivateLinkResource < adx.control.JSONMapper
...
% (c) 2023 MathWorks Inc.
    ...
    properties
        % xproperties - type: PrivateLinkResourceProperties
        xproperties adx.control.models.PrivateLinkResourceProperties { adx.control.JSONMapper.fieldName(xproperties,"properties") }
        % systemData - type: systemData
    ...
    methods
        % Constructor
        function obj = PrivateLinkResource(s,inputs)
            ...
            arguments
                ...
                inputs.?adx.control.models.PrivateLinkResource
            end
