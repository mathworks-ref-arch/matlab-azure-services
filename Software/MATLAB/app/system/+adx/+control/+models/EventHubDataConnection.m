classdef EventHubDataConnection < adx.control.JSONMapper
...
% (c) 2023 MathWorks Inc.
    ...
    properties
        % xproperties - type: EventHubConnectionProperties_1
        xproperties adx.control.models.EventHubConnectionProperties_1 { adx.control.JSONMapper.fieldName(xproperties,"properties") }
        % id - Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName} - type: string
    ...
    methods
        % Constructor
        function obj = EventHubDataConnection(s,inputs)
            ...
            arguments
                ...
                inputs.?adx.control.models.EventHubDataConnection
            end
