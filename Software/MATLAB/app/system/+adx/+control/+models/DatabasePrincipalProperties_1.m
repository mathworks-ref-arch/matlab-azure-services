classdef DatabasePrincipalProperties_1 < adx.control.JSONMapper
...
% (c) 2023 MathWorks Inc.
    ...
    properties
        ...
        % role - Database principal role. - type: string
        role adx.control.models.DatabasePrincipalProperties_1RoleEnum { adx.control.JSONMapper.fieldName(role,"role") }
        % tenantId - The tenant id of the principal - type: string
        tenantId string { adx.control.JSONMapper.fieldName(tenantId,"tenantId") }
        % principalType - Principal type. - type: string
        principalType adx.control.models.DatabasePrincipalProperties_1PrincipalTypeEnum { adx.control.JSONMapper.fieldName(principalType,"principalType") }
        % tenantName - The tenant name of the principal - type: string
    ...
    methods
        % Constructor
        function obj = DatabasePrincipalProperties_1(s,inputs)
            ...
            arguments
                ...
                inputs.?adx.control.models.DatabasePrincipalProperties_1
            end
