classdef ClusterPrincipalProperties < adx.control.JSONMapper
...
% (c) 2023 MathWorks Inc.
    ...
    properties
        ...
        % role - Cluster principal role. - type: string
        role adx.control.models.ClusterPrincipalPropertiesRoleEnum { adx.control.JSONMapper.fieldName(role,"role") }
        % tenantId - The tenant id of the principal - type: string
        tenantId string { adx.control.JSONMapper.fieldName(tenantId,"tenantId") }
        % principalType - Principal type. - type: string
        principalType adx.control.models.ClusterPrincipalPropertiesPrincipalTypeEnum { adx.control.JSONMapper.fieldName(principalType,"principalType") }
        % tenantName - The tenant name of the principal - type: string
    ...
    methods
        % Constructor
        function obj = ClusterPrincipalProperties(s,inputs)
            ...
            arguments
                ...
                inputs.?adx.control.models.ClusterPrincipalProperties
            end
