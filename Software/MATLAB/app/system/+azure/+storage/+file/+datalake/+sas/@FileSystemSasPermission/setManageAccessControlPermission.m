function fileSystemSasPermission = setManageAccessControlPermission(obj, permission)
...
fileSystemSasPermissionj = obj.Handle.setManageAccessControlPermission(permission);
